...
class ExtractorTests(unittest.TestCase):
    ...
    def test_pipeline_emits_summary(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as tmp_dir:
            ...
            alias_ambiguity_payload = json.loads((output_dir / "alias_ambiguity.json").read_text(encoding="utf-8"))
        ...
        self.assertEqual(alias_ambiguity_payload["ambiguous_mention_count"], summary_payload["ambiguous_mentions"])
        self.assertIn("top_surfaces", alias_ambiguity_payload)
        self.assertIn("top_entities", alias_ambiguity_payload)
        ...
        self.assertIn("collection", stage_summary_payload)
        self.assertIn("extraction", stage_summary_payload)
        ...
        self.assertIn("stage_summary", summary_payload)
