...
5. 输出 `output/nodes.json`、`output/relation_instances.json`、`output/edges.json`、`output/graph_index.json`、`output/graph_quality.json`、`output/career_profiles.json`、`output/recommendation_index.json`、`output/data_catalog.json`、`output/relation_summary.json`、`output/extraction_log.json` 和 `output/graph_manifest.json`。
